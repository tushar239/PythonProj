...
This cursor is on DB side and records are fetched one by one lazily, unless you say connection.cursor(buffered=true). 
When you buffer it, all the records will be fetched from DB cursor and kept in memory.
"""

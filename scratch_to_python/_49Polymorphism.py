...
# Same method can be called with different number of parameter values. So, it is polymorphic in nature.
def add(x, y, z=0):
    return x + y + z
...
"""
Method overriding is also one type of Polymorphism.
...
print(isinstance(obj_spr, Bird))  # True
print(issubclass(sparrow, Bird))  # True
obj_spr.intro()
obj_spr.flight()

print(isinstance(obj_ost, Bird))  # True
print(issubclass(ostrich, Bird))  # True
obj_ost.intro()
obj_ost.flight()

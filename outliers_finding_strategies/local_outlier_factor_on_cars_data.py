...
# Fit LOF model. n_neighbors is same has number of neighbours in KNN algorithm. Here, I have taken square root of 50001 (total records) 223.6
lof = LocalOutlierFactor(n_neighbors=224)

...
-1: This placeholder tells NumPy to automatically calculate the size of that dimension based on the total number of elements in the array and the other specified dimensions. 
    In this case, it will determine the number of rows needed to accommodate all elements.
...
'''
# is same as
a_2D_array = a.reshape(-1,1) # (-1) means “infer this dimension automatically” based on the total size of the array.
print(a_2D_array)
'''
[[False]
 [False]
